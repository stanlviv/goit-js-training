let text3 = `Напиши скрипт, який імітує авторизацію адміністратора в панелі управління.
...
function task3(){
    ...
    if (!pass) {
        ...
        message = pass === ADMIN_PASSWORD ? "Ласкаво просимо!" : "Доступ заборонений, невірний пароль!";
    }
    alert(message);
}